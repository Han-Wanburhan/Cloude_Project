...
$sql = "SELECT post.*, USER.*, COUNT(LIKE.id_post) AS like_amount FROM post LEFT JOIN `like` ON post.id = LIKE.id_post LEFT JOIN USER ON post.id_user = USER.id  WHERE id_post=1 GROUP BY post.id";
	...
	<div class="postviewer">
		<div class="left">
			...
			<div class="behind-box">
				<div class="image_post"><?php  echo $row['image']; ?></div>
			</div>
		</div>
		<div class="right">
			<div class="top">
